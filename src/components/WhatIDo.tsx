        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building responsive, role-based full-stack web applications with
                the MERN stack, RESTful APIs, JWT authentication, and cloud deployment.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Solid Computer Science foundation in Data Structures, Algorithms,
                DBMS, Operating Systems, Computer Networks, and OOP.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
